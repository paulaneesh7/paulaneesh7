...
## 💻 Tech Stack:
[![My Skills](https://skillicons.dev/icons?i=c,java,python,html,css,javascript,tailwindcss,mysql,supabase,firebase,git,github,linux,netlify,replit,vscode&perline=8)](https://skillicons.dev)
